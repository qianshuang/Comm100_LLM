...
model_path = "/opt/share/chatglm/models/finetune/Qwen2.5-14B-Instruct-Comm100"
...
question = """hello, who are you please?"""

messages = [{"role": "system", "content": infer_sys_message}, {"role": "user", "content": question}]
