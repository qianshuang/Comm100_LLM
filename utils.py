...
# 日志配置
logger = logging.getLogger("Comm100_LLM_logger")
logger.setLevel(logging.INFO)
handler = ConcurrentTimedRotatingFileHandler(filename="log/Comm100_LLM", when="MIDNIGHT", interval=1, backupCount=3, encoding="utf-8")
